...
export class AdmProdutoPage {
  ...
  constructor(
    ...
    if (_prod && _prod._id) {
      ...
      this.produto.categoriaId = _prod.categoriaId;
      console.log(this.produto.categoriaId,'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAa');
    }
    else
...
ionViewWillEnter(){
  this.loadData();
  console.log('AdmProdutosPage ionViewWillEnter');
}
